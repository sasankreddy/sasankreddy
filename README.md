...
- **Tools & Technologies**: Git, GitHub, GitLab, AWS EKS, GCP GKE, DevOps,Continuous Integration, Continuous Delivery, Docker, Kubernetes, Jenkins, Terraform, Spring, Microservices
- **Other Skills**: Software Development, Problem Solving, Team Collaboration
...
- **Emotion Recognition Using Machine Learning**: Implemented facial expression recognition using Python and CNN to analyze online activities, enhancing virtual learning engagement. Published in the International Journal of Innovative Research - October 2023.
